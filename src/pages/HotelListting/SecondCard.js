...
import BR2_0 from "images/HOTELLISTTING/RoomImg2/BR2_0.png";
import BR2_1 from "images/HOTELLISTTING/RoomImg2/BR2_1.png";
import BR2_2 from "images/HOTELLISTTING/RoomImg2/BR2_2.png";
import BR2_3 from "images/HOTELLISTTING/RoomImg2/BR2_3.png";
import BR2_4 from "images/HOTELLISTTING/RoomImg2/BR2_4.png";
...
export class SecondCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nav1: null,
                      ...
                      <Col md={6} sm={6} xs={12}>
                        <div className="HotelListCardText">
                          ...
                          <div className="HotelListCardRatingText">
                            ...
                            <span className="RatingNumber">(2987 Rating)</span>
                            <span>Excellent</span>
                          </div>
                          {!this.props.active && (
                          ...
                          <div className="CardPrice d-flex align-items-center">
                            ...
                            <span className="RoomOffer">20% OFF</span><h6>Per room per night</h6>
                            </div>
                            <div>
